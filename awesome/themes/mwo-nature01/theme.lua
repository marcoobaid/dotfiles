...
theme.fg_normal                                 = "#FEFEFE" -- FEFEFE
theme.fg_focus                                  = "#7b88d3"
theme.fg_urgent                                 = "#b74822"
theme.bg_normal                                 = "#5D8745" --  5D8745
theme.bg_focus                                  = "#CCDA5E"
theme.bg_urgent                                 = "#3F3F3F"
theme.taglist_fg_focus                          = "#9D4804"
theme.tasklist_bg_focus                         = "#222222"
theme.tasklist_fg_focus                         = "#b74822"
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            arrow("alpha", "#5D8745"),
            wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, 3, 6), "#5D8745"),
            arrow("#5D8745", "#22532F"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#22532F"),
            arrow("#22532F", "#5D8745"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#5D8745"),
            arrow("#5D8745", "#22532F"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#22532F"),
            arrow("#22532F", "#5D8745"),
            ...
            --arrow("#4B3B51", "#CB755B"),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#5D8745"),
            arrow("#5D8745", "#22532F"),
            ...
            --arrow("#C0C0A2", "#777E76"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#22532F"),
            arrow("#22532F", "alpha"),
            --]]
            s.mylayoutbox,
        },
